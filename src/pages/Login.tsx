...
export default function Login() {
  ...
  return (
    <AuthShell
      title="Sign in."
      subtitle="Continue organising what you think."
      footer={
        <>
          New here?{" "}
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="space-y-1.5">
          <div className="flex items-baseline justify-between">
            ...
            <Link to="/forgot-password" className="text-[11px] text-white/50 hover:text-white">
              Forgot?
            </Link>
          </div>
          <input
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-[11px] uppercase tracking-[0.2em]">
            <span className="bg-black px-3 text-white/40">or</span>
          </div>
        </div>
