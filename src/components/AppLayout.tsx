  ...
  return (
    <div className="flex min-h-screen bg-background text-foreground">
      ...
      {!isGraphPage && !isNoteEditor && (
        ...
        >
          <div className="flex items-center justify-around gap-0.5 rounded-2xl border border-white/10 bg-secondary/85 px-1 py-1 shadow-[0_10px_30px_rgba(0,0,0,0.35)] backdrop-blur-sm supports-[backdrop-filter]:bg-secondary/85">
            {mobileTabs.map((it) => (
              <NavLink
                key={it.to}
                to={it.to}
